...
> **Scanner:** `@axe-core/playwright` 4.11.x against staging (`<web-container-app>` revision 0157)
...
| 2026-04-26 | Fix shipped in revision `<web-container-app>--0000159`. Re-scan against live deploy: 4/4 public pages pass clean.                                                                                                                  | `b0f3375`         |
