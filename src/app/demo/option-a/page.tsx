    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="fixed left-6 top-20 z-40 max-w-xs rounded-lg border border-blue-200 bg-blue-50 p-3 shadow-lg dark:border-blue-900 dark:bg-blue-950">
        ...
        <p className="mt-1 text-xs text-blue-700 dark:text-blue-300">
          Hover over dock icons at the bottom to see magnification effect.
          Full content width, no sidebar.
        </p>
      </div>
    </div>
  );
...
function DemoRoomsContent() {
  const rooms = [
    ...
    { id: '5', name: 'HR Documents', status: 'active', documents: 34, members: 6, lastActivity: '5 hours ago' },
    { id: '6', name: 'Compliance Audit', status: 'active', documents: 56, members: 10, lastActivity: '1 hour ago' },
  ];
