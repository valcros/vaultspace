...
export default function SysOpRunnerPage() {
  ...
  const logs = [
    `[2026-08-14 17:24:36 UTC] [BUILD] Deployment to Azure Staging succeeded. Revision: ca-vaultspace-web--0000306.`,
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="border-slate-200 bg-white backdrop-blur dark:border-slate-800 dark:bg-slate-900/60">
          ...
          <CardContent className="space-y-2">
            ...
            <p className="text-[11px] text-slate-500">Accountable Authority: Mark Munger</p>
          </CardContent>
        </Card>
      </div>
