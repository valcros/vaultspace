    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="mx-auto max-w-6xl px-4 py-6">
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-lg font-semibold text-neutral-900">Your Questions</h2>
          {ownQuestions.length === 0 ? (
            <Card className="p-8 text-center">
              <MessageCircle className="mx-auto mb-3 h-10 w-10 text-neutral-400" />
              <p className="text-neutral-500">You haven&apos;t asked any questions yet.</p>
            </Card>
          ) : (
              ...
              {ownQuestions.map((q) => {
                ...
                return (
                  <Card key={q.id} className="overflow-hidden">
                    <button
                      className="flex w-full items-center gap-3 p-4 text-left hover:bg-neutral-50"
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          <span className="truncate font-medium text-neutral-900">{q.subject}</span>
                    ...
                    {isExpanded && (
                      <div className="border-t bg-neutral-50 px-4 py-4">
                        <p className="whitespace-pre-wrap text-sm text-neutral-700">{q.body}</p>
                        {q.answers.length > 0 && (
        ...
        {/* Public Q&A */}
        <section>
          <h2 className="mb-4 text-lg font-semibold text-neutral-900">Public Q&amp;A</h2>
          {publicQuestions.length === 0 ? (
            <Card className="p-8 text-center">
              <MessageCircle className="mx-auto mb-3 h-10 w-10 text-neutral-400" />
              <p className="text-neutral-500">No public questions and answers yet.</p>
            </Card>
          ) : (
            <div className="space-y-3">
