...
export const RATE_LIMIT_CONFIG = {
  ...
  PASSWORD_RESET_ATTEMPTS_PER_EMAIL_PER_HOUR: 3,
  PASSWORD_RESET_ATTEMPTS_PER_IP_PER_HOUR: 10,
  REGISTRATION_ATTEMPTS_PER_IP_PER_HOUR: 10,
  EMAIL_VERIFICATION_RESEND_PER_EMAIL_PER_HOUR: 3,
  EMAIL_VERIFICATION_RESEND_PER_IP_PER_HOUR: 10,
  CLIENT_DIAGNOSTICS_PER_USER_PER_MINUTE: 10,
