      ...
      <div className="space-y-3">
        {rooms.slice(0, 4).map((room, index) => (
          <Link
            key={room.id}
            href={`/rooms/${room.id}`}
            className="group block rounded-xl border border-neutral-200 bg-white p-4 shadow-sm transition-all hover:shadow-md hover:border-primary-200 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-primary-800"
          >
            ...
            <div className="mt-4 grid grid-cols-3 gap-2 text-xs">
              <div className="rounded-lg bg-neutral-50 px-3 py-2 dark:bg-neutral-800">
                ...
                <p className="mt-1 text-sm font-semibold text-neutral-900 dark:text-neutral-100">{room.documentCount}</p>
              </div>
              <div className="rounded-lg bg-neutral-50 px-3 py-2 dark:bg-neutral-800">
                <div className="flex items-center gap-1 text-neutral-500 dark:text-neutral-400">
                ...
                <p className="mt-1 text-sm font-semibold text-neutral-900 dark:text-neutral-100">{room.viewerCount}</p>
              </div>
              <div className="rounded-lg bg-neutral-50 px-3 py-2 dark:bg-neutral-800">
                <div className="flex items-center gap-1 text-neutral-500 dark:text-neutral-400">
                ...
                <p className="mt-1 text-sm font-semibold text-neutral-900 dark:text-neutral-100">{room.questionCount}</p>
              </div>
            </div>
