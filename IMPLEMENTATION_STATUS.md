...
| Area                              | Status                                                                                                                                                                                   |
| --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Live URL                          | https://<web-container-app>.<azure-container-app-suffix>.eastus.azurecontainerapps.io                                                                                                        |
...
- DNS: wildcard CNAME `*.vaultspace.org` → Container App FQDN (Azure DNS zone in `<azure-resource-group>`)
...
Live verification 2026-04-26: `https://REDACTED.vaultspace.org/` returns `307 → /auth/login?org=REDACTED` with `x-middleware-rewrite: /org/REDACTED`. Branding API at `https://REDACTED.vaultspace.org/api/public/branding` returns the seed org's branding payload.
